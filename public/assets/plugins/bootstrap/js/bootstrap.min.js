...
!(function (t, e) {
  ...
  class ct extends R {
    constructor(t, e) {
      super(t, e),
        ...
        (this._indicatorsElement = Y.findOne(".portfolio-indicators", this._element)),
    ...
    _addEventListeners() {
      this._config.keyboard && $.on(this._element, "keydown.bs.portfolio", (t) => this._keydown(t)),
        "hover" === this._config.pause &&
          ($.on(this._element, "mouseenter.bs.portfolio", () => this.pause()),
          $.on(this._element, "mouseleave.bs.portfolio", () => this._maybeEnableCycle())),
        this._config.touch && J.isSupported() && this._addTouchEventListeners();
    }
    _addTouchEventListeners() {
      for (const t of Y.find(".portfolio-item img", this._element))
        $.on(t, "dragstart.bs.portfolio", (t) => t.preventDefault());
      const t = {
    ...
    _slide(t, e = null) {
      ...
      if (r("slide.bs.portfolio").defaultPrevented) return;
      if (!i || !n) return;
      const a = Boolean(this._interval);
      this.pause(), (this._isSliding = !0), this._setActiveIndicatorElement(o), (this._activeElement = n);
      const l = s ? "portfolio-item-start" : "portfolio-item-end",
        c = s ? "portfolio-item-next" : "portfolio-item-prev";
      n.classList.add(c),
        g(n),
        i.classList.add(l),
        n.classList.add(l),
    ...
    _getActive() {
      return Y.findOne(".active.portfolio-item", this._element);
    }
    _getItems() {
      return Y.find(".portfolio-item", this._element);
    }
    _clearInterval() {
  ...
  $.on(document, "click.bs.portfolio.data-api", "[data-bs-slide], [data-bs-slide-to]", function (t) {
    const e = r(this);
    ...
    $.on(window, "load.bs.portfolio.data-api", () => {
      const t = Y.find('[data-bs-ride="portfolio"]');
